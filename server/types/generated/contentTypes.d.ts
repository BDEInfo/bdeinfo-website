...
export interface ApiBdeInformationBdeInformation
  extends Struct.SingleTypeSchema {
  collectionName: 'bde_informations';
  info: {
    description: '';
    displayName: 'BDE Informations';
    pluralName: 'bde-informations';
    singularName: 'bde-information';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::bde-information.bde-information'
    > &
      Schema.Attribute.Private;
...
export interface ApiBdeMemberBdeMember extends Struct.CollectionTypeSchema {
  collectionName: 'bde_members';
  info: {
    description: '';
    displayName: 'BDE Member';
    pluralName: 'bde-members';
    singularName: 'bde-member';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    carouselDelayInSeconds: Schema.Attribute.Integer &
    ...
    location: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'IUT Informatique Lyon 1 - Doua'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLinkLink extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    linktree: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPostePoste extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::poste.poste'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::bde-information.bde-information': ApiBdeInformationBdeInformation;
      'api::bde-member.bde-member': ApiBdeMemberBdeMember;
